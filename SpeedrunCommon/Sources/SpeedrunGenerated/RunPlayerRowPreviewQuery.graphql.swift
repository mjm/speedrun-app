...
extension RelaySwiftUI.Query.WrappedValue where O == RunPlayerRowPreviewQuery {
    public func get(id: String, fetchKey: Any? = nil) -> RelaySwiftUI.Query<RunPlayerRowPreviewQuery>.Result {
