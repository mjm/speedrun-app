...
extension RelaySwiftUI.Query.WrappedValue where O == RunDetailScreenQuery {
    public func get(id: String, fetchKey: Any? = nil) -> RelaySwiftUI.Query<RunDetailScreenQuery>.Result {
